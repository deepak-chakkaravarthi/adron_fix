    ...
    <div class="container">
        <form id="product-form" action="{{ route('products.update', $product->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div id="suppliers-container">
                    @foreach ($product->suppliers as $supplier)
                        <div class="supplier-item" id="supplier-{{ $supplier->id }}">
                            <input type="hidden" name="existing_supplier_ids[]" value="{{ $supplier->id }}">
                            <span>{{ $supplier->name }} - {{ $supplier->contact_info }}</span>
                            <button type="button" class="remove-btn remove-supplier-btn" data-supplier-id="{{ $supplier->id }}">Remove</button>
                        </div>
                    @endforeach
                </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="profit_margin_value" name="profit_margin_value" value="{{ $product->profit_margin_value }}" required>
            </div>

            <div class="form-footer">
                <button type="submit">Update Product</button>
                <a href="{{ route('products.list') }}" class="back-link">Back to Product List</a>
            </div>
        </form>
    </div>
